...
export const ProductsView = () => {
    ...
    const handleClick = async (product: any) => {
        setOrderItems([...orderItems.filter((item: any) => item.product !== product.id && item.id !== product.id), product]);
            ...
            {products.map((product: Product) => (
                <Grid key={product.id} item>
                    <Paper
                        ...
                        >
                        <img className="thumbnail" src={product.imageUploadURL} alt={product.name} />
                        <br />
